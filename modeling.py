  ...
  def __init__(self,
    ...
    with tf.variable_scope(scope, default_name="bert"):
      ...
      with tf.variable_scope("encoder"):
        ...
        attention_mask = create_attention_mask_from_adj_mask(
            input_ids, adj_mask)
...
def create_attention_mask_from_adj_mask(from_tensor, to_mask):
   """Create 3D attention mask from a 2D tensor mask.
   ...
   to_mask = tf.cast(
       tf.reshape(to_mask, [batch_size, from_seq_length, from_seq_length]), tf.float32)
...
def transformer_model(input_tensor,
  ...
  if do_return_all_layers:
    final_outputs = []; final_attention_outputs = []
